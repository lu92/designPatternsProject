 ...
 */
public class PriceBruttoGreaterThanCriteria extends BaseProductCriteria{

    private double value;

    public PriceBruttoGreaterThanCriteria(double value) {
        this.value = value;
    }

    public PriceBruttoGreaterThanCriteria(BaseProductCriteria next, double value) {
        super(next);
        this.value = value;
    }
